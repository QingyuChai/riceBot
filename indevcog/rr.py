...
class Russianroulette:
    ...
    def __init__(self, bot):
        self.bot = bot
        self.money = "data/money/account.json"
        self.riceCog = dataIO.load_json(self.money)
            ...
            if settings["System"]["Roulette Initial"]:
                if user.id in settings["Players"]:
                    ...
                    if bet == settings["System"]["Start Bet"]:
                        ...
                        self.subtract_credits(user, bet)
    ...
    async def roulette_game(self, settings, server):
        ...
        while count > 0:
            ...
            if count > 1:
                ...
                balance = _cog._add_money(winner, pot)
                break
    ...
    def subtract_credits(self, user, bet):
        _cog = self.bot.get_cog("Money")
        _cog._substract_money(user, bet)
