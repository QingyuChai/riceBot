...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes riceBot's global settings."""
    ...
    async def game(self, ctx, *, game=None):
        ...
        if game:
            ...
            log.debug('status cleariceBot by owner')
        await self.bot.say("Done.")
    ...
    async def stream(self, ctx, streamer=None, *, stream_title=None):
        ...
        if stream_title:
            ...
            await self.bot.change_presence(game=None, status=current_status)
            log.debug('stream cleariceBot by owner')
        await self.bot.say("Done.")
    ...
    async def info(self):
        ...
        about = (
            ...
            "riceBot is backed by a passionate community who contributes and "
        ...
        embed.add_field(name="About riceBot ", value=about, inline=False)
    ...
    async def version(self):
        """Shows riceBot's current version"""
